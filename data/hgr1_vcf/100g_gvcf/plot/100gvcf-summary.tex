...
100g. & 15.9\% & 2.81 & 10.7\% & 0.000 &  60 &19 \\ 
\end{tabular}
\vspace{2em}
\begin{itemize}[-]
\setlength{\itemsep}{0pt}
\item 100g. .. \texttt{\footnotesize 100g.hgr1\_all.vcf}
\end{itemize}\end{minipage}}


% SNP and indel counts by AF
%
\hslide{}{\vbox{\noindent\includegraphics[type=pdf,ext=.pdf,read=.pdf,width=23cm]{100gvcf-counts_by_af.snps}\\%
\noindent\includegraphics[type=pdf,ext=.pdf,read=.pdf,width=23cm]{100gvcf-counts_by_af.indels}}}

% Ts/Tv by AF
%
\hslide{Ts/Tv by AF}{\includegraphics[type=pdf,ext=.pdf,read=.pdf,width=15cm]{100gvcf-tstv_by_af.0}}

% Ts/Tv stratified by QUAL
%
\hslide{Ts/Tv stratified by QUAL}{\includegraphics[type=pdf,ext=.pdf,read=.pdf,width=15cm]{100gvcf-tstv_by_qual.0}}

% Indel distribution
%
\hslide{Indel distribution}{\includegraphics[type=pdf,ext=.pdf,read=.pdf,width=15cm]{100gvcf-indels.0}}

% Depth distribution
%
\hslide{Depth distribution}{\includegraphics[type=pdf,ext=.pdf,read=.pdf,width=15cm]{100gvcf-depth.0}}

% Substitution types
%
\hslide{Substitution types}{\includegraphics[type=pdf,ext=.pdf,read=.pdf,width=15cm]{100gvcf-substitutions.0}}
